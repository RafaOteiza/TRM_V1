...
(function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch("/static/myapp/js/pro.json")
            ...
            const htmlContent = `
                <div class="col-lg-4 col-md-6 mb-3">
                    <div class="box" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <div class="btn-wrap">
                            <button class="btn-buy" data-id="${promo.id}">Comprar</button>
                        </div>
                    </div>
                </div>`;
    ...
    function setupCartButtons(promotions) {
    ...
    function addToCart(promo) {
        let cart = JSON.parse(localStorage.getItem('cart')) || [];
        const existingPromo = cart.find(p => p.id === promo.id);
        if (existingPromo) {
        ...
        alert(`${promo.titulo} ha sido añadido al carrito.`);
    }
});
